...
//		ffmpeg -i input.mp4 -y output.avi
    ...
    public static void main(String[] args) {
        FFMpegVideoCutUtil ffmpeg = getInstance();
        String videoPath = "E:\\video\\2-10socket相关_慕课网.mp4";
...
//        BigDecimal b2 = new BigDecimal(190);
//        BigDecimal b3 = new BigDecimal(290);
//        BigDecimal b4 = new BigDecimal(201);
//        BigDecimal b5 = new BigDecimal(99);
//
//        System.out.println(b1.divide(bigDecimal, 2, BigDecimal.ROUND_HALF_UP).intValue());
//        ;
//        System.out.println(b2.divide(bigDecimal, 2, BigDecimal.ROUND_HALF_UP).intValue());
//        ;
//        System.out.println(b3.divide(bigDecimal, 2, BigDecimal.ROUND_HALF_UP).intValue());
//        ;
//        System.out.println(b4.divide(bigDecimal, 2, BigDecimal.ROUND_HALF_UP).intValue());
//        ;
//        System.out.println(b5.divide(bigDecimal, 2, BigDecimal.ROUND_HALF_UP).intValue());
//        ;
