...
import com.imooc.utils.FFMpegVideoCutUtil;
...
//        service.cutProject("E:\\BaiduNetdiskDownload\\剑指Java面试-Offer直通车_cut");
        service.cutProject("E:\\BaiduNetdiskDownload\\剑指Java面试-Offer直通车");
//        service.findFileAndCutFile(new File("E:\\BaiduNetdiskDownload\\剑指Java面试-Offer直通车_cut"), "E:\\BaiduNetdiskDownload\\剑指Java面试-Offer直通车_cut");
    }

//    public static void main(String[] args) {
//        ProjectService service = new ProjectService();
//        service.additionalCutFile(new File("E:\\BaiduNetdiskDownload\\剑指Java面试-Offer直通车_cut"));
//    }
}
